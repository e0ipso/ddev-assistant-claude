...
- **Seeds host configuration** on start: your host `~/.claude/` tree is mounted read-only under `/home/.cred-seed/claude/`, then mirrored into the writable container `~/.claude/` directory on every restart:
